...
#endif
#if defined(NT35596_AUO55_BYD_FHD)
	&nt35596_auo55_byd_fhd_lcm_drv,
#endif
#if defined(NT35532_AUO55_TRULY_FHD)
	&nt35532_auo55_truly_fhd_lcm_drv,
#endif
...
#if defined(NT35595_SHARP50_HUAYI_FHD)
	&nt35595_sharp50_huayi_fhd_lcm_drv,
#endif
...
#if defined(ILI7807D_CMI55_HONGZHAN_FHD)
	&ili7807d_cmi55_hongzhan_fhd_lcm_drv,
#endif
...
#if defined(HX8398A_AUO55_XINLI_FHD)
	&hx8398a_auo55_xinli_fhd_lcm_drv,
#endif
